...
import (
	...
	"github.com/azcov/gokit/auth/oauth/facebook"
)

func TestAuthorizeURL(t *testing.T) {
	p := facebook.New(facebook.Config{ClientID: "cid-123", ClientSecret: "secret-xyz"})
...
func TestAuthorizeURL_CustomScopes(t *testing.T) {
	p := facebook.New(facebook.Config{ClientID: "cid", ClientSecret: "sec"})
...
func TestClose(t *testing.T) {
	...
	_ = facebook.New(facebook.Config{})
}
