...
import (
	...
	"github.com/azcov/gokit/auth/oauth/twitter"
)

func TestAuthorizeURL(t *testing.T) {
	p := twitter.New(twitter.Config{ClientID: "cid-123", ClientSecret: "secret-xyz"})
...
func TestAuthorizeURL_CustomScopes(t *testing.T) {
	p := twitter.New(twitter.Config{ClientID: "cid", ClientSecret: "sec"})
