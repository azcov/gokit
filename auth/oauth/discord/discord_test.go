...
import (
	...
	"github.com/azcov/gokit/auth/oauth/discord"
)

func TestAuthorizeURL(t *testing.T) {
	p := discord.New(discord.Config{ClientID: "cid-123", ClientSecret: "secret-xyz"})
...
func TestAuthorizeURL_CustomScopes(t *testing.T) {
	p := discord.New(discord.Config{ClientID: "cid", ClientSecret: "sec"})
