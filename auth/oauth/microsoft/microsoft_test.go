...
import (
	...
	"github.com/azcov/gokit/auth/oauth/microsoft"
)

func TestAuthorizeURL(t *testing.T) {
	p := microsoft.New(microsoft.Config{ClientID: "cid-123", ClientSecret: "secret-xyz"})
...
func TestAuthorizeURL_CustomScopes(t *testing.T) {
	p := microsoft.New(microsoft.Config{ClientID: "cid", ClientSecret: "sec"})
...
func TestClose(t *testing.T) {
	...
	_ = microsoft.New(microsoft.Config{})
}
