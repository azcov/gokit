...
import (
	...
	"github.com/azcov/gokit/auth/oauth/google"
)

func TestAuthorizeURL(t *testing.T) {
	p := google.New(google.Config{ClientID: "cid-123", ClientSecret: "secret-xyz"})
...
func TestAuthorizeURL_CustomScopes(t *testing.T) {
	p := google.New(google.Config{ClientID: "cid", ClientSecret: "sec"})
